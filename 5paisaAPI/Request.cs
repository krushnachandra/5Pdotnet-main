...
namespace _5paisaAPI
{
    ...
    public class RequestCode
    {
        ...
        public string ModifyRegularOrder { get; set; }

        public string CancelOrderRequest { get; set; }
    ...
    {
        public Head head { get; set; }
        public ModifyOrderRequest body { get; set; }
    }
    ...
    public class JsonData
    {
        ...
        public ModifyOrderRequest ModifyOrderRequest { get; set; }
        public CancelOrderRequest CancelOrderRequest { get; set; }
        ...
        public MarketFeed MarketFeedTabOne { get;  set; }
